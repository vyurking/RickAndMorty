...
final class RMEpisodeDetailView: UIView {
    ...
    private func createCollectionView() -> UICollectionView{
        ...
        collectionView.register(RMEpisodeInfoCollectionViewCell.self, forCellWithReuseIdentifier: RMEpisodeInfoCollectionViewCell.cellIdentifer)
...
extension RMEpisodeDetailView {
    ...
    func createCharacterLayout() -> NSCollectionLayoutSection {
        ...
        let group = NSCollectionLayoutGroup.horizontal(layoutSize: .init(
            widthDimension: .fractionalWidth(1),
            heightDimension: .absolute(240)), subitems: [item, item])
...
extension RMEpisodeDetailView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case .information(let viewModel):
            ...
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: RMEpisodeInfoCollectionViewCell.cellIdentifer, for: indexPath) as? RMEpisodeInfoCollectionViewCell else {
                fatalError()
            }
